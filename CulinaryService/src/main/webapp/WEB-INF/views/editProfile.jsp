...
<div class="edit-recipe-container">
    ...
    <div class="form-group">
        <c:if test="${not empty user.avatarPath}">
            <img src="${pageContext.request.contextPath}/image?file=${user.avatarPath}" alt="Аватар пользователя"
                 class="avatar">
        </c:if>
            ...
            <div>
                <c:forEach var="preference" items="${preferences}">
                    <div>
                        ...
                        <c:forEach items="${user.preferences}" var="userPref">
                            <c:if test="${userPref.name eq preference}">
                                <c:set var="isChecked" value="true"/>
                            </c:if>
                        </c:forEach>

                        <input type="checkbox" id="preference-${preference}"
