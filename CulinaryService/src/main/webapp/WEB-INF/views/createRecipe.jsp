...
<div class="recipe-form-container">
    ...
    <form class="create-recipe-form" action="${pageContext.request.contextPath}/recipe/create" method="post"
        ...
        <div class="form-group">
            <label for="preparationTime">Время приготовления (в минутах):</label>
            <input type="number" id="preparationTime" name="preparationTime" required min="1">
        </div>
        ...
        <div class="form-group">
            ...
            <div>
                <c:forEach var="preference" items="${preferences}">
                    <div>
                        <input type="radio" id="preference-${preference}" name="category" value="${preference}"
                               required>
        ...
        <label for="coverImage">Обложка рецепта:</label>
